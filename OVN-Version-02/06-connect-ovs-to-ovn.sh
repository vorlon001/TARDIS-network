...
docker exec -it ovsdb-server ovs-vsctl set open . external-ids:ovn-remote=tcp:[2001:db8:600:1234::180]:6642,tcp:[2001:db8:600:1234::181]:6642,tcp:[2001:db8:600:1234::182]:6642
docker exec -it ovsdb-server ovs-vsctl set open . external-ids:ovn-encap-ip=[2001:db8:600:1234::${NODEID}]
...
docker exec -it ovn-northd ovn-nbctl --db=tcp:[2001:db8:600:1234::180]:6641,tcp:[2001:db8:600:1234::181]:6641,tcp:[2001:db8:600:1234::182]:6641 show
docker exec -it ovn-northd ovn-sbctl --db=tcp:[2001:db8:600:1234::180]:6642,tcp:[2001:db8:600:1234::181]:6642,tcp:[2001:db8:600:1234::182]:6642 show
