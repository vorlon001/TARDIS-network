...
vppctl set interface ip address GigabitEthernet3/3/0.800 192.168.203.173/24
...
vppctl set interface ip address GigabitEthernet3/3/0.803 10.0.0.173/24
vppctl ip route add 10.0.0.0/24 via  GigabitEthernet3/3/0.803

vppctl create sub GigabitEthernet3/3/0  804
vppctl set interface state GigabitEthernet3/3/0.804 up
vppctl set interface mtu packet 1500 GigabitEthernet3/3/0.804
vppctl set interface ip address GigabitEthernet3/3/0.804 192.168.0.173/24
vppctl ip route add 192.168.0.0/24 via  GigabitEthernet3/3/0.804
...
vppctl lcp create GigabitEthernet3/3/0.804 host-if ge804

ifconfig ge800 192.168.203.173/24 up
ifconfig ge803 10.0.0.173/24 up
ifconfig ge804 192.168.0.173/24 up
