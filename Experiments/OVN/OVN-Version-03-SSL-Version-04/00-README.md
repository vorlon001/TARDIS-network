      ...
      node3 (Gateway, 192.168.203.3:VLAN800, UBUNTU 22.04LTS)
                          ...
                          --------------- VLAN800 ---------------------------------
                                     ...
                                     node180 (VTEP-VPP, 192.168.203.180:VLAN800, UBUNTU 22.04LTS)
                                             ...
                                             |                                                          |                   |
                                             |                                                          |                   |
   node180 (OVN-CENTRAL,OVS, [2001:db8:400:1234::180]:VLAN200, UBUNTU 22.04LTS)                                  |                   |
                                                                                                        |                   |
                                                                                                        |                   |
                                              node180 (OVN-CENTRAL,OVS, [2001:db8:400:1234::180]:VLAN200, UBUNTU 22.04LTS)           |
                                                                                                                            |
...
# OVN CENTRAL
## ON CENTRAL 1 node180 node181 node182

### ON v1 node180 node181 node182
...
sshpass -f pass_file ssh -o StrictHostKeyChecking=no root@192.168.200.181 mkdir /etc/openvswitch
sshpass -f pass_file ssh -o StrictHostKeyChecking=no root@192.168.200.182 mkdir /etc/openvswitch
sshpass -f pass_file scp -o StrictHostKeyChecking=no /etc/openvswitch/*pem 192.168.200.181://etc/openvswitch
sshpass -f pass_file scp -o StrictHostKeyChecking=no /etc/openvswitch/*pem 192.168.200.182://etc/openvswitch
EOF
chmod +x e.sh
./e.sh
```
...
OVN_CTL_OPTS=" \
  ...
  --db-nb-addr=[2001:db8:400:1234::180] \
  --db-sb-addr=[2001:db8:400:1234::180] \
  --db-nb-cluster-local-addr=[::] \
  --db-sb-cluster-local-addr=[::] \
  --ovn-northd-nb-db=ssl:[2001:db8:400:1234::180]:6641,ssl:[2001:db8:400:1234::181]:6641,ssl:[2001:db8:400:1234::182]:6641 \
  --ovn-northd-sb-db=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642 \
...
OVN_CTL_OPTS=" \
  --db-nb-create-insecure-remote=no \
  --db-sb-create-insecure-remote=no \
  --db-nb-addr=[2001:db8:400:1234::181] \
  --db-sb-addr=[2001:db8:400:1234::181] \
  --db-nb-cluster-local-addr=[2001:db8:400:1234::181] \
  --db-sb-cluster-local-addr=[2001:db8:400:1234::181] \
  --db-nb-cluster-remote-addr=[2001:db8:400:1234::180] \
  --db-sb-cluster-remote-addr=[2001:db8:400:1234::180] \
  --ovn-northd-nb-db=ssl:[2001:db8:400:1234::180]:6641,ssl:[2001:db8:400:1234::181]:6641,ssl:[2001:db8:400:1234::182]:6641 \
  --ovn-northd-sb-db=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642 \
  --ovn-northd-ssl-key=/etc/openvswitch/ovnnorthd-privkey.pem \
  --ovn-northd-ssl-cert=/etc/openvswitch/ovnnorthd-cert.pem \
...
OVN_CTL_OPTS=" \
  --db-nb-create-insecure-remote=no \
  --db-sb-create-insecure-remote=no \
  --db-nb-addr=[2001:db8:400:1234::182] \
  --db-sb-addr=[2001:db8:400:1234::182] \
  --db-nb-cluster-local-addr=[2001:db8:400:1234::182] \
  --db-sb-cluster-local-addr=[2001:db8:400:1234::182] \
  --db-nb-cluster-remote-addr=[2001:db8:400:1234::180] \
  --db-sb-cluster-remote-addr=[2001:db8:400:1234::180] \
  --ovn-northd-nb-db=ssl:[2001:db8:400:1234::180]:6641,ssl:[2001:db8:400:1234::181]:6641,ssl:[2001:db8:400:1234::182]:6641 \
  --ovn-northd-sb-db=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642 \
...
#ovn-nbctl --inactivity-probe=60000 set-connection pssl:6641:[::]
#ovn-sbctl --inactivity-probe=60000 set-connection pssl:6642:[::]

export NODEID=$(echo $(ifconfig enp1s0.200 | grep 192.168.200. | awk '{print $2}') | sed 's|192.168.200.||')
ovs-vsctl set Open_vSwitch . external-ids:ovn-remote=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642

ovs-vsctl set Open_vSwitch .  \
  external_ids:ovn-remote=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642 \
  external_ids:ovn-encap-ip=2001:db8:400:1234::${NODEID} \
...
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::180]:6641 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Northbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::181]:6641 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Northbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::182]:6641 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Northbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"


ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::180]:6642 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Southbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::181]:6642 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Southbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem query ssl:[2001:db8:400:1234::182]:6642 "[\"_Server\",{\"table\":\"Database\",\"where\":[[\"name\",\"==\", \"OVN_Southbound\"]],\"columns\": [\"leader\"],\"op\":\"select\"}]"




ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::180]:6641 
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::181]:6641 
ovsdb-client  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::182]:6641 


ovsdb-client  --private-key=/etc/openvswitch/ovnsb-privkey.pem --certificate=/etc/openvswitch/ovnsb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::180]:6642 
ovsdb-client  --private-key=/etc/openvswitch/ovnsb-privkey.pem --certificate=/etc/openvswitch/ovnsb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::181]:6642 
ovsdb-client  --private-key=/etc/openvswitch/ovnsb-privkey.pem --certificate=/etc/openvswitch/ovnsb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem  dump  ssl:[2001:db8:400:1234::182]:6642 
...
OVN_NB_DB=ssl:[2001:db8:400:1234::180]:6641,ssl:[2001:db8:400:1234::181]:6641,ssl:[2001:db8:400:1234::182]:6641 ovn-nbctl  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem show
OVN_SB_DB=ssl:[2001:db8:400:1234::180]:6642,ssl:[2001:db8:400:1234::181]:6642,ssl:[2001:db8:400:1234::182]:6642 ovn-sbctl  --private-key=/etc/openvswitch/ovnnb-privkey.pem --certificate=/etc/openvswitch/ovnnb-cert.pem --ca-cert=/etc/openvswitch/cacert.pem show
...
OVN_NB_DB=ssl:[2001:db8:400:1234::180]:6641,ssl:[2001:db8:400:1234::181]:6641,ssl:[2001:db8:400:1234::182]:6641 
