...
KUBERNETES_HOSTNAMES=kubernetes,kubernetes.default,kubernetes.default.svc,kubernetes.default.svc.cluster.local,node180,node181,node182,node180.cloud.local,node181.cloud.local,node182.cloud.local,10.96.128.1,192.168.200.180,192.168.200.181,192.168.200.182,192.168.200.189
...
openssl verify -verbose -CAfile root.bundle.kubernetes.crt kube-proxy.pem
