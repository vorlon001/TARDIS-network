...
wget -q --show-progress --https-only --timestamping -O kubernetes-server-linux-amd64.1.28.2.tar.gz https://storage.googleapis.com/kubernetes-release/release/v1.28.2/kubernetes-server-linux-amd64.tar.gz
