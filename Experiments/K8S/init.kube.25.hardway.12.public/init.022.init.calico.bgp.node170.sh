...
calicoctl patch node node170 -p '{"spec": {"bgp": {"asNumber": "65000"}}}'
calicoctl patch node node171 -p '{"spec": {"bgp": {"asNumber": "65000"}}}'
calicoctl patch node node172 -p '{"spec": {"bgp": {"asNumber": "65000"}}}'
