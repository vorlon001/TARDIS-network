...
apt install devscripts equivs cmake make gcc clang git-buildpackage git -y
git clone https://github.com/frrouting/frr.git frr
cd frr
git checkout stable/8.5


nano -c debian/rules
rules:43:       dh_auto_configure -- \
rules:60:               --enable-fpm \
rules:61:               --enable-sharpd \
## ^^^^^^ ADDD
...
# for build sharpd
gbp buildpackage --git-builder=dpkg-buildpackage --git-debian-branch="$(git rev-parse --abbrev-ref HEAD)" $options --git-ignore-new
...
# not work!!!!
# node180
ip route add 2001:db8:66:80:100::/128 encap seg6local action End.DT4 nh4 0.0.0.0 vrftable 10  dev enp1s0.600
# node181
ip route add 2001:db8:66:81:100::/128 encap seg6local action End.DT4 nh4 0.0.0.0 vrftable 10  dev enp1s0.800
## ip vrf exec vrf1 tcpdump -ni enp1s0.800
## ip vrf exec vrf1 tcpdump -ni vrf1

# work!!!!!!!!!!!!!
# node180
ip route add 2001:db8:66:80:100::/128 encap seg6local action End.DX4 nh4 0.0.0.0 table 10  dev enp1s0.600
# node181
ip route add 2001:db8:66:81:100::/128 encap seg6local action End.DX4 nh4 0.0.0.0 table 10  dev enp1s0.800


root@node181:~# ip nex list
id 10 dev enp1s0.800 scope link proto zebra
id 11 dev enp1s0.200 scope link proto zebra
id 12 dev enp1s0.400 scope link proto zebra
id 13 dev enp1s0.400 scope link proto zebra
id 14 dev enp1s0.200 scope link proto zebra
id 16 dev enp1s0 scope link proto zebra
id 17 dev enp1s0.800 scope link proto zebra
id 18 via 192.168.200.1 dev enp1s0.200 scope link proto zebra
id 23 dev lo scope link proto zebra
id 27 blackhole proto zebra
id 29  encap seg6local action End.DT6 table 10 dev vrf1 scope link proto zebra
id 31 via fe80::f816:3eff:fe44:cba8 dev enp1s0.200 scope link proto zebra
id 35 group 31/36 proto zebra
id 36 via fe80::f816:3eff:fead:7d87 dev enp1s0.200 scope link proto zebra
id 38 via 2001:db8:200:1234::180 dev enp1s0.200 scope link proto zebra
id 42  encap seg6 mode encap segs 1 [ 2001:db8:66:80:200:: ] via 2001:db8:200:1234::180 dev enp1s0.200 scope link proto zebra
id 44  encap seg6 mode encap segs 1 [ 2001:db8:66:80:100:: ] via 2001:db8:200:1234::180 dev enp1s0.200 scope link proto zebra
id 56  encap seg6local action End.DX4 nh4 0.0.0.0 dev enp1s0.800 scope link proto zebra

root@node181:~# ip nexthop list vrf vrf1
id 10 dev enp1s0.800 scope link proto zebra
id 17 dev enp1s0.800 scope link proto zebra
id 56  encap seg6local action End.DX4 nh4 0.0.0.0 dev enp1s0.800 scope link proto zebra
...
root@node181:~# ip rule list table 10
root@node181:~# ip route list table  10
192.168.202.0/24 nhid 44  encap seg6 mode encap segs 1 [ 2001:db8:66:80:100:: ] via inet6 2001:db8:200:1234::180 dev enp1s0.200 proto bgp metric 20
...
node180# show bgp ipv4 vpn
BGP table version is 2, local router ID is 192.168.201.180, vrf id 0
...
*> 192.168.202.0/24 2001:db0:80:1234::@4
                                             0         32768 ?
    UN=2001:db0:80:1234:: EC{65000:1010} label=4096 sid=2001:db8:66:80:100:: sid_structure=[40,24,16,0] type=bgp, subtype=5
*>i192.168.203.0/24 2001:db0:81:1234::
                                             0    100      0 ?
    UN=2001:db0:81:1234:: EC{65000:1010} label=4096 sid=2001:db8:66:81:100:: sid_structure=[40,24,16,0] type=bgp, subtype=0
...
VRF vrf1:
C>* 192.168.202.0/24 is directly connected, enp1s0.600, 02:01:16
B>  192.168.203.0/24 [20/0] via 2001:db0:81:1234:: (vrf default) (recursive), label 4096, seg6local unspec unknown(seg6local_context2str), seg6 2001:db8:66:81:100::, weight 1, 01:59:18
  *                           via 2001:db8:200:1234::181, enp1s0.200 (vrf default), label 4096, seg6local unspec unknown(seg6local_context2str), seg6 2001:db8:66:81:100::, weight 1, 01:59:18
