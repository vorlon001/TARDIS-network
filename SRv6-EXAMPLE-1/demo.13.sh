...
#  | veth0 |          |                  |          |                  |          |                  |           | veth5 |
#  +-------+      10.0.0.254/24     fdff::1/64   fdff::2/64  172.16.0.254/24  172.16.0.253/24    10.0.1.254/24   +-------+
#                     |               ^  |          |  ^               |          |                  |
...
$IPP netns exec cer $IPP addr add 10.0.1.254/24 dev veth6
...
$IPP netns exec h1 $IPP addr add 10.0.1.2/24 dev veth7
$IPP netns exec h1 $IPP -4 route add default via 10.0.1.254 dev veth7
