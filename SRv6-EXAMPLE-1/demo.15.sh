...
# https://github.com/netgroup/srv6-vpns/
...
#  | veth0 |          |                  |      |                  |        | veth5 |
#  +-------+      10.0.0.254/24    fdff::1/64  fdff::2/64   10.0.1.254/24   +-------+
#                     |                 ^|      |v                 |
...
$IPP netns exec r0 $IPP -4 route add 10.0.1.0/24 \
...
$IPP netns exec r1 $IPP addr add 10.0.1.254/24 dev veth4
# Decap DX4
...
$IPP netns exec r1 $IPP -4 route add 10.0.0.0/24 \
...
$IPP netns exec h1 $IPP addr add 10.0.1.2/24 dev veth5
$IPP netns exec h1 $IPP -4 route add default via 10.0.1.254 dev veth5
