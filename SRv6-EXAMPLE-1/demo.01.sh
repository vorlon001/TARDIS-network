...
# https://github.com/skjune12/srv6-playground/blob/master/scripts/create-namespaces.sh
...
# ip netns exec router1 ip -6 route del fc00:c::/64 encap seg6 mode encap segs fc00:b::10 dev veth-rt1-h1
# ip netns exec router1 ip -6 route add fc00:c::/64 encap seg6 mode encap segs fc00:b::10,fc00:b::20 dev veth-rt1-h1
#
# ADDON 2
#
# ip netns exec router3 ip -6 route del fc00:a::/64 via fc00:23::1
# ip netns exec router3 ip -6 route add fc00:a::/64 encap seg6 mode encap segs fc00:b::10,fc00:b::20 dev veth-rt3-h2
# ip netns exec host1 ping6 -c 3 fc00:c::2
# ip netns exec node1 tcpdump -i veth-node1-rt2
# ip netns exec node1 tcpdump -i veth-node2-rt2
# ip netns exec router1 ip -6 route add fc00:c::/64 encap seg6 mode encap segs fc00:b::10,fc00:b::20 dev veth-rt1-h1
#
