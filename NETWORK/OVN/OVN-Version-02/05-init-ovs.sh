...
export NODE1=[2001:db8:600:1234::180]
...
OVNICIP=[2001:db8:600:1234::${NODEID}]
OVNHOSTIP=[2001:db8:600:1234::${NODEID}]
EOF
...
-v /root/ovs/log:/var/log/openvswitch/ -v /root/ovs/lib:/var/lib/openvswitch -v /root/ovs/run:/var/run/openvswitch  \
ovn:v10
docker ps -a
# STEP 3
# in pod  ovsdb-server
...
-v /root/ovs/log:/var/log/openvswitch/ -v /root/ovs/lib:/var/lib/openvswitch -v /root/ovs/run:/var/run/openvswitch ovn:v10
docker ps -a
