...
ip netns exec dataplane ip link set dev bvi1 address de:ad:88:00:${NODEMACID}:01

ip netns exec dataplane ip link show
ip netns exec dataplane ping 192.168.203.1 -c 8
ip netns exec dataplane ping 192.168.203.2 -c 8
ip netns exec dataplane ping 192.168.203.3 -c 8
