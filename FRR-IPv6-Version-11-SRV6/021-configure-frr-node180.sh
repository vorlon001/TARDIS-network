...
ip vrf exec vrf1 sysctl -w net.ipv4.conf.all.proxy_arp=1
...
interface enp1s0.200
 ipv6 address 2001:db8:200:1234::180/64
!
interface lo
 ipv6 address 2001:db0:80:1234::1/128
!
...
router bgp 65000
 ...
 address-family ipv6 unicast
  network 2001:db8:0:180::/64
  network 2001:db0:80:1234::/64
  network 2001:db8:66:80::/64
...
router bgp 65000 vrf vrf1
 ...
 address-family ipv4 unicast
  ...
  nexthop vpn export 2001:db0:80:1234::
...
!
!
ipv6 route 2001:db0:180:1234::/64 blackhole
!
"

vtysh -c "show run" >021-configure-frr-node180.config.v2
cp /etc/netplan/00-installer-config.yaml 021-config-netplan-node180.config.v2
vtysh -c "write"
